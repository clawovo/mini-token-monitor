...
struct TokenMonitorWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Mini Token Monitor")
...
struct TokenMonitorWidgetView: View {
    ...
    var body: some View {
        Group {
            if let snapshot = entry.snapshot {
                ...
                statusState(title: WidgetL10n.text("Waiting for data"), detail: WidgetL10n.text("Open Mini Token Monitor once"))
            }
        }
    ...
    private var brand: some View {
        ...
        .accessibilityLabel("Mini Token Monitor")
    }
