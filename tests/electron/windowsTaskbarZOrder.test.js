...
// The Windows "keep above taskbar" opt-in no longer has a settings row (the
// Window section was removed), but the keeper itself still honors the stored
// preference, so the remaining tests below exercise the keeper directly.
