...
// Canonical Mini Token Monitor identity for client ids emitted by Tokscale. Keep
...
function parseGraphResult(raw) {
  ...
  for (const row of rows) {
    ...
    for (const c of clientRows) {
      ...
      // Keep it out of Mini Token Monitor's message/activity semantics; its tokens and
