...
const { readBoundedJson, REASONIX_META_MAX_BYTES } = require('./fileIo');
const { resolveReasonixHome } = require('./paths');
...
function countReasonixProviderMessages(events) {
  // Mini Token Monitor's native session `messageCount` is the provider-message
