...
function createTray({
  ...
  tray.setToolTip('Mini Token Monitor');
...
function popoverBounds(tray, popoverWidth, popoverHeight) {
  ...
  if (process.platform === 'darwin') {
    // Flush against the menu bar: the status item bounds already end at the
    // menu bar's bottom edge, so any added offset shows as a gap above the popover.
