...
const GITHUB_URL = 'https://github.com/clawovo/mini-token-monitor';
...
const CLIENT_LABELS = {
  ...
  pi: 'Pi', zed: 'Zed', kilo: 'Kilo', commandcode: 'Command Code', micode: 'MiMo Code', zcode: 'ZCode', kiro: 'Kiro', codebuddy: 'CodeBuddy', workbuddy: 'WorkBuddy', proma: 'Proma', qodercn: 'Qoder CN', reasonix: 'Reasonix', dsh: 'DeepSeek Harness', cherrystudio: 'Cherry Studio', lmstudio: 'LM Studio', unsloth: 'Unsloth', penguin: 'Penguin Harness',
  gemini: 'Gemini'
};
...
function buildPayload(stats, currency = 'USD', compactTokenUnits = 'western', locale = 'en') {
  ...
  const base = {
    type: 0,
    largeImageKey: 'logo',
    largeImageText: 'Mini Token Monitor',
    startTimestamp,
    buttons: [{ label: 'View on GitHub', url: GITHUB_URL }]
  };
  if (totalTokens === 0) {
    return { ...base, details: 'Mini Token Monitor', state: 'No usage today' };
  }
