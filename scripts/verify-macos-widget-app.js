...
function verifyMacWidgetApp({
  ...
  exactArchitectures(path.join(paths.contents, 'MacOS', appInfo.CFBundleExecutable || 'Mini Token Monitor'), expectedArch, spawnSyncImpl);
...
if (require.main === module) {
  ...
  verifyMacWidgetApp({
    ...
    widgetBundleId: process.env.TOKEN_MONITOR_WIDGET_BUNDLE_ID || 'com.ai.minitokenmonitor.widget',
